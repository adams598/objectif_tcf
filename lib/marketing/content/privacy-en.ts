...
export const privacyEn: LegalContent = {
  ...
  lastUpdated: "Last updated: 1 November 2023",
  sections: [
    {
      title: "Our commitment",
      paragraphs: [
        "Our privacy commitment aims to detail our practices regarding the collection, use and confidentiality of your data when you use our services. Our goal is to inform you of your privacy rights and of the measures taken to protect your information.",
        "We use your personal information to improve our services. By using our platform, you consent to the collection and use of your information in accordance with our privacy policy. It has been designed according to our own data-protection guidelines.",
      ],
    },
    {
      title: "Interpretation and definitions",
      paragraphs: [
        "Words whose initial letter is capitalised have the meanings defined in the following conditions. The following definitions shall have the same meaning whether they appear in the singular or in the plural.",
      ],
    },
    {
      title: "Definitions",
      ...
      list: [
        ...
        {
          text: "Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to objectif-canada-tcf.",
        },
        {
        ...
        {
          text: "Service refers to the Website and everything related to it.",
        },
        {
        ...
        {
          text: "Website refers to Objectif TCF, accessible [from this link](https://objectif-tcf.org).",
        },
        {
    ...
    },
    {
      ...
      subsections: [
          ...
          subsections: [
            {
              ...
              paragraphs: [
                ...
                "You can learn more about cookies [by clicking here](https://www.termsfeed.com/privacy-policy-generator/#faq-8).",
              ...
              list: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    { text: "Administered by: Us on the Website" },
                    {
        ...
        },
        {
          ...
          listAfterParagraphs: [
            {
              text: "With Service Providers: we may share your personal information with Service Providers to monitor and analyse the use of our Service, to contact you.",
            },
            {
            ...
            {
              text: "With Affiliates: we may share your information with our affiliates, in which case we will require those affiliates to honour this Privacy Policy. Affiliates include our parent company and any other subsidiaries, joint venture partners or other companies that we control or that are under common control with us.",
            },
            {
