...
export function ExamView({ seriesId, guestMode, examTab }: ExamViewProps) {
  ...
  // Hydratation depuis la tentative en cours (reprise après déconnexion).
  useEffect(() => {
  ...
  }, [answers, seriesId, examTab, guestMode, router, QUESTIONS, flushAutosave]);
  ...
  // Aligner le timer sur le temps restant côté serveur une fois les données
  // chargées.
  useEffect(() => {
